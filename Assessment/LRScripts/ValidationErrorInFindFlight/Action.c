...
Action()
{
	...
	truclient_step("4", "Click on findFlights button", "snapshot=Action_4.inf");
	truclient_step("5", "Press OK in alert dialog", "snapshot=Action_5.inf");
	truclient_step("6", "Verify Find Flight 's 'Visible Text' Contain Find Flight", "snapshot=Action_6.inf");
